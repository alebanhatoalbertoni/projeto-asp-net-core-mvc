...
{
    public class Departaments1Controller : Controller
    {
        private readonly SalesWebMvcContext _context;

        public Departaments1Controller(SalesWebMvcContext context)
        {
            _context = context;
        }
        ...
        // GET: Departaments1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Departaments1/Create
